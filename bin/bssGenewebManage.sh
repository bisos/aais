...
IcmBriefDescription="bsrGenewebManage.sh -- Create and maintain geneweb databases."
...
_EOF_
  ...
  vis_examplesBxSvcLogInfo ${oneSr}
}
...
function vis_dbaseInitialContentStdout {
  ...
  dbaseName=$1
   ...
   opDoRet echo NOTYET bystarHereAnalyzeAcctBagp
...
1 CHAR UTF-8
0 @I3@ INDI
1 NAME ${cp_FirstName:-firstName} /${cp_LastName:-lastName}/
1 SEX M
1 DEAT
0 @F1@ FAM
0 TRLR
